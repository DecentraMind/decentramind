...
const compareImages = async (): void => {
  ...
  const oriUrl = 'https://4kwallpapers.com/images/walls/thumbs_3t/1455.jpg'
  const {mssim} = ssim(await getImageDataFromURL('https://pbs.twimg.com/profile_images/1801571505647849473/Zbu80-_C_normal.jpg'), await getImageDataFromURL(oriUrl)) as ssimType
